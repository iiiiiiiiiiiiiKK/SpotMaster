{getStatColor(stats.changePercent30d)}import React, { useState, useEffect, useRef, useMemo } from 'react';
            ...
            const renderBoxedCell = (val) => {
                ...
                return (
                    ...
                    <div className="w-12 px-0.5 h-full flex items-center justify-center">
                        ...
                        <div className="w-full rounded py-0.5 font-bold text-[7px] sm:text-sm text-center" style={{ backgroundColor: bgColor, color: textColor }}>
                           {val !== undefined ? `${val > 0 ? '+' : ''}${val.toFixed(2)}%` : '-'}
                        </div>
                    </div>
                )
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-3 text-12 font-bold mt-2">
